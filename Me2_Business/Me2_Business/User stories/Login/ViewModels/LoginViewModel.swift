            ...
            .responseJSON { (response) in
                ...
                case .success(let result):
                    ...
                    case 0:
                        ...
                        let isNotificationsOn = json["data"]["user"]["notification_data"]["live_chat"].boolValue
                        ...
                        UserDefaults().set(isNotificationsOn, forKey: UserDefaultKeys.notificationsSubscriptionStatus.rawValue)
